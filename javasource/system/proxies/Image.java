...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Cinema.HomePageHeader", mendixObject.getType())) {
			return cinema.proxies.HomePageHeader.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Cinema.MovieImage", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("Cinema.Ticket", mendixObject.getType())) {
			return cinema.proxies.Ticket.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Cinema.TicketDocument", mendixObject.getType())) {
