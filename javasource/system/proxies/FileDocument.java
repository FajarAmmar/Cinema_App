...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("Cinema.CSVFile", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("Cinema.Document", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("Cinema.TransactionDocumentUser", mendixObject.getType())) {
			return cinema.proxies.TransactionDocumentUser.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Cinema.movieTransactionDocument", mendixObject.getType())) {
